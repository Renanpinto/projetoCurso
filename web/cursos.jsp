        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="text-center">
                        <div class="card" style="width: 30rem;">
                            <img class="card-img-top" src="img/java.jpg" alt="Card image cap" style="width: 29rem; height: 15rem">
                            <div class="card-body">
                ...
                <div class="col-md-6 ">
                    <div class="text-center">
                        <div class="card" style="width: 30rem;">
                            <img class="card-img-top" src="img/python.jpg" alt="Card image cap" style="width: 29rem; height: 15rem">
                            <div class="card-body">
